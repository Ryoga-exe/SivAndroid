...
void handle_cmd(android_app *pApp, int32_t cmd) {
  ...
  case APP_CMD_INIT_WINDOW:
    ...
    // APP_CMD_TERM_WINDOW handler case. pApp->userData = new Renderer(pApp);
    break;
  case APP_CMD_TERM_WINDOW:
    ...
    //            if (pApp->userData) {
    //                //
    //                auto *pRenderer = reinterpret_cast<Renderer
    //                *>(pApp->userData); pApp->userData = nullptr; delete
    //                pRenderer;
    //            }
    break;
  default:
...
void android_main(struct android_app *pApp) {
  ...
  do {
    ...
    //        if (pApp->userData) {
    //            // We know that our user data is a Renderer, so reinterpret
    //            cast it. If you change your
